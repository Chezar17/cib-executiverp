// ── PANEL DATA ──────────────────────────────────────────────
  const PANEL_META = {
    ...
    announcements: {bc:'NEXUS · PUBLIC AFFAIRS',  title:'Public Announcements',        sub:'CIB public communications · Press releases · Official statements',           badge:'<span style="font-family:\'Roboto Mono\',monospace;font-size:8px;letter-spacing:2px;padding:3px 10px;background:rgba(79,195,247,0.1);color:#4fc3f7;border:1px solid rgba(79,195,247,0.3);">PUBLIC FACING</span>'},
  };
